...
@overload
def as_array(obj: ctypes._PointerLike, shape: Sequence[int], dtype: None | DTypeLike, order: None | _OrderCF) -> NDArray[Any]: ...
@overload
def as_array(obj: _ArrayLike[_SCT], order: None | _OrderCF, shape: None | _ShapeLike = ... ) -> NDArray[_SCT]: ...
@overload
def as_array(obj: object, order: None | _OrderCF, shape: None | _ShapeLike = ...) -> NDArray[Any]: ...
